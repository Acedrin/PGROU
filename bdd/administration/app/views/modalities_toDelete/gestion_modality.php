...
/* --------------------------------------------------
  Projet MOOWSE
  Fichier html
  Vue de l'interface de gestion des modalités d'accès des clients de MooWse
...
if (isset($_SESSION['login'])) {
    require("../controllers/getModalities.php");
    ...
    <html lang="fr-fr">
        <head>
            ...
            <meta charset="UTF-8" />
            <title>MooWse - Gestion modalités de connexion des clients</title>
        </head>
        <body>
            <div class="navigation">
                <h1>Espace Administration de MooWse</h1>
                <h2>Gestion modalités de connexion des clients</h2>
