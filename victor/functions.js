...
// Fonction pour remplir le formulaire de modifiation d'une variable
function modifierVariable(id,name,input,order,type_id) {
    document.getElementById('var_id').value = id;
    document.getElementsByName('variable_name')[0].value = name;
    document.getElementsByName('variable_order')[0].value = order;
    
    document.getElementsByName('type_id')[0].selectedIndex = type_id;
